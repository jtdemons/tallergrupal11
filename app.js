...
app.delete('/deletePoll/:id', (req, res) =>
{
	...
	muestraEncuesta(token,(error,data)=>
	{
		console.log(data);
		queryMysql('delete from respuesta where idEncuestas = '${data.idEncuestas}'',(error opciones)=>
		queryMysql('delete delete respuesta where idEncuestas = '${data.idEncuestas}'',(error opciones)=>
